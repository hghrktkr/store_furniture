...
// scripts/walkInCooler/walkInCoolerBlock.ts
var WalkInCoolerBlock = class {
  static getDirection(block) {
  ...
  static isOpen(block) {
    const isOpen = block.permutation.getState("edu:is_open");
  ...
  static getBottom(block) {
    const bottomBlock = block.below();
    if (bottomBlock === void 0) {
  ...
  static setTop(block) {
    ...
    const dir = this.getDirection(block);
    const isOpen = this.isOpen(block);
    if (topBlock === void 0 || !topBlock.isAir) return;
    if (dir === void 0) return;
    if (isOpen === void 0) return;
...
// scripts/walkInCooler/walkInCoolerManager.ts
var WalkInCoolerManager = class {
  ...
  static onInteractBottom(ev) {
    ...
    if (topBlock === void 0) return;
    if (currentIsOpen === void 0) return;
